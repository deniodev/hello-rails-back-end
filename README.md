...
**[Hello rails back end]** is an api that generates random greetings.

## Front-End <a name="frond-end"></a>
- The api is consumed by this [React project](https://github.com/deniodev/hello-react-front-end/)
...
Feel free to check the [issues page](https://github.com/deniodev/hello-rails-back-end/issues).
